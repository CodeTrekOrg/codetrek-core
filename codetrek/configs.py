...
cmd_opt.add_argument('--num_steps', default=10, type=int, help='number of steps in each random walks')
cmd_opt.add_argument('--desc_gen', default=True, type=bool, help='whether to extract/store information about the most relevant walks and steps')
cmd_opt.add_argument('--top_k_walks', default=1, type=int, help='number of top walks to look at for description generation')
